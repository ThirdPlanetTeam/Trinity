                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center" class="w640" height="20" width="640">
                                    <a href="http://www.ewo-le-monde.com/site/mail/affiche.php?id={IDMAIL}" style="color:#ffffff; font-size:12px"><span style="color:#ffffff; font-size:12px">Voir le contenu de ce mail en ligne</span></a>
                                </td>
                            </tr>
                                                ...
                                                <td class="w580" width="580">
                                                    <table border="0" cellpadding="0" cellspacing="0" class="w580" width="580">
                                                        <tbody>
                                                            <tr>
                                                                <td class="w580" width="580">
                                                                    <h2 style="color:#0E7693; font-size:22px; padding-top:12px">{{ $subject }}</h2>
